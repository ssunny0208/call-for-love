...
function loadDialogue() {
  ...
  text2_2 = [
    ...
    "P:아 저 오늘 불우 이웃 돕기 연말 행사 있거든요~ 정리할 게 이것저것 많네요.",
    "M: 오, 봉사도 해요? 진짜 대단하시다.",
    "P: 제가 한 대단 하죠.",
...
function setupListOfDialogue() {
  ...
  dictionary_1 = {
    //숫자게임
    3549: "	Manhattan의 1×30-5번한테 전화 걸어주세요. 	",
  ...
  dictionary_3 = {
    ...
    3226: "	아들네 집으로 내가 만든 쿠키~ 좀 보내고 싶군요... 가만 보자... 우체국이 어디였죠?	",
    ...
    5063: "	저 여기 양말 공장 앞인데, 아무래도 불이 난 거 같아요... 큰일이에요.	",
  };
  dictionary_4 = {
    30: "	Roger	",
    31: "	Mimi	",
  ...
  introText = [
    "오늘은 1947년 12월 23일.",
    "나는 New York 시의 전화교환원. Queens, Manhattan, Bronx, Brooklyn 사람들의 전화 연결을 담당한다.",
...
function setupListOfCard() {
  ...
  window_1 = loadImage("icon/window_1.PNG");
  window_2 = loadImage("icon/window_2.PNG");
